...
\label{FIG-POD-VAR}
\end{figure}
These two modes are displayed on figure \ref{FIG-POD-HIGH-MODES}.
\begin{figure}[H]
\centering
...
Some low variance modes are displayed on figure \ref{FIG-POD-LOW-MODES}.
\begin{figure}[H]
\centering
...
The x-axis displays time in seconds and the y-axis the length of the object.
