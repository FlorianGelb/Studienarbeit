...
By calculating the partial fraction decomposition as described in section \ref{secdcnf}, the DCNF can be obtained.
...
\begin{gather}
||\epsilon(s)||_{H_2} \leq \sum_{i \in I_r^{c}} \frac{1}{\sqrt{2|\operatorname{Re}(\lambda_i)|}} \leq \frac{|I_r^{c}|}{\sqrt{2|\max(\Lambda_{\epsilon})|}}\,.
\end{gather}
