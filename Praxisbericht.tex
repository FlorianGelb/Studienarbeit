...
\pagestyle{plain}
\include{content/03_indexes/abkuerzungen}
...
\begingroup
\let\clearpage\relax
\include{content/04_content/intro}
\include{content/04_content/HeatEq}
\include{content/04_content/FEM}
\include{content/04_content/svd}
\include{content/04_content/ctl}
\include{content/04_content/rom}
\include{content/04_content/pod}
\include{content/04_content/bt}
\include{content/04_content/mt}
\include{content/04_content/hna}
\include{content/04_content/impl}
\include{content/04_content/analysis}
\include{content/04_content/conclusion}
\endgroup
...
\include{content/04_content/appendix}
\newpage
\end{document}